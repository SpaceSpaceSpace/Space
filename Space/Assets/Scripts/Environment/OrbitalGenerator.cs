...
public class OrbitalGenerator : MonoBehaviour {
	...
	void Start () {
		...
		generateBelt (50, new Vector2 (90.0f, 90.0f), false);
		generateBelt (50, new Vector2 (100.0f, 100.0f), false);
		generateBelt (55, new Vector2 (110.0f, 110.0f), false);
		generateBelt (60, new Vector2 (120.0f, 120.0f), false);
		generateBelt (65, new Vector2 (130.0f, 130.0f), false);
		generateBelt (60, new Vector2 (140.0f, 140.0f), false);
